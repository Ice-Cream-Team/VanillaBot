    ...
    execute(msg, args){
        ...
        switch(args[0])
        {
            ...
            case cl.c.cmdSvrList.cmd:
                ...
                break;
            default:
                msg.channel.send(" :icecream: The command you used for server is incorrect, try using **!vb server list** for info about the servers availible! :icecream: ")
                break;
        }
    }
};